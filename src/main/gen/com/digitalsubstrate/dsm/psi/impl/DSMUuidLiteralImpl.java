...
public class DSMUuidLiteralImpl extends ASTWrapperPsiElement implements DSMUuidLiteral {

  public DSMUuidLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DSMVisitor visitor) {
    visitor.visitUuidLiteral(this);
  }
  ...
  public PsiElement getUuid() {
    return notNullChild(findChildByType(UUID));
  }
