...
public class DSMUserTypeReferenceImpl extends DSMUserTypeReferenceMixin implements DSMUserTypeReference {

  public DSMUserTypeReferenceImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DSMVisitor visitor) {
    visitor.visitUserTypeReference(this);
  }
