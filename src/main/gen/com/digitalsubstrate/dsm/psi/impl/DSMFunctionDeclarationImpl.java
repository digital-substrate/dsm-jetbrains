...
public class DSMFunctionDeclarationImpl extends ASTWrapperPsiElement implements DSMFunctionDeclaration {

  public DSMFunctionDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
