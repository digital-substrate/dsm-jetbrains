...
public class DSMListLiteralImpl extends ASTWrapperPsiElement implements DSMListLiteral {

  public DSMListLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<DSMLiteralValue> getLiteralValueList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, DSMLiteralValue.class);
  }
