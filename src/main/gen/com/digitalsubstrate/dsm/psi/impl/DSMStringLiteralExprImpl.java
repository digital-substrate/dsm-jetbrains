...
public class DSMStringLiteralExprImpl extends ASTWrapperPsiElement implements DSMStringLiteralExpr {

  public DSMStringLiteralExprImpl(@NotNull ASTNode node) {
    super(node);
  }
