...
public class DSMMembershipDeclarationImpl extends ASTWrapperPsiElement implements DSMMembershipDeclaration {

  public DSMMembershipDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DSMVisitor visitor) {
    visitor.visitMembershipDeclaration(this);
  }
