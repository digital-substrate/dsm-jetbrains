...
public class DSMIdentifierOrKeywordImpl extends ASTWrapperPsiElement implements DSMIdentifierOrKeyword {

  public DSMIdentifierOrKeywordImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DSMVisitor visitor) {
    visitor.visitIdentifierOrKeyword(this);
  }
