...
public class DSMParameterImpl extends ASTWrapperPsiElement implements DSMParameter {

  public DSMParameterImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public DSMIdentifierOrKeyword getIdentifierOrKeyword() {
    return PsiTreeUtil.getChildOfType(this, DSMIdentifierOrKeyword.class);
  }
