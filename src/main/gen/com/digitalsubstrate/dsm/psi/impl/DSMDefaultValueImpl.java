...
public class DSMDefaultValueImpl extends ASTWrapperPsiElement implements DSMDefaultValue {

  public DSMDefaultValueImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public DSMLiteralValue getLiteralValue() {
    return notNullChild(PsiTreeUtil.getChildOfType(this, DSMLiteralValue.class));
  }
